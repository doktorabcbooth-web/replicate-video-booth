...
export default function CameraCapture() {
  ...
  const [prompt, setPrompt] = useState<string>(() => `The subject in [Image1] (person from selfie) comes to life on the football pitch, taking the place of the player in [Video1]. He dribbles forward at a controlled pace, weaving through defenders. Movement is deliberate and grounded — natural athletic motion. He shifts weight, fakes left, beats the last defender, and slots the ball into the bottom corner. The goalkeeper dives but can't reach it. The stadium crowd cheers softly in the background. Preserve the subject's face, identity, and body texture from [Image1] throughout. Photorealistic, shot on cinema camera, natural stadium floodlight lighting, shallow depth of field on subject, broadcast TV football aesthetic, slight motion blur on the ball.`)
